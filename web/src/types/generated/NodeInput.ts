...
export type NodeInput =
  | { type: 'HttpRequest'; data: HttpInput }
  | { type: 'Agent'; data: AgentInput }
  | { type: 'Python'; data: PythonInput }
  | { type: 'Print'; data: PrintInput }
  | { type: 'Email'; data: EmailInput }
  | { type: 'ManualTrigger'; data: ManualTriggerInput }
  | { type: 'WebhookTrigger'; data: WebhookTriggerInput }
  | { type: 'ScheduleTrigger'; data: ScheduleInput }
