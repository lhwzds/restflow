...
import type { EmailOutput } from "./EmailOutput";
 ...
 */
export type NodeOutput = { "type": "Http", "data": HttpOutput } | { "type": "Agent", "data": AgentOutput } | { "type": "Python", "data": PythonOutput } | { "type": "Print", "data": PrintOutput } | { "type": "Email", "data": EmailOutput } | { "type": "ManualTrigger", "data": ManualTriggerOutput } | { "type": "WebhookTrigger", "data": WebhookTriggerOutput } | { "type": "ScheduleTrigger", "data": ScheduleOutput };
