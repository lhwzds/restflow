#!/usr/bin/env python3
"""Build, install, and smoke-test the RestFlow Python package."""
...
DEFAULT_TARGET_DIR = Path("/tmp/restflow-python-target")
...
def smoke(env: dict[str, str]) -> None:
    code = (
        ...
        "tmp=tempfile.TemporaryDirectory(prefix='restflow-package-smoke-');"
