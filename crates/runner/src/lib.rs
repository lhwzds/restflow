...
mod runtime {
    ...
    pub mod executor {
        ...
        //! - `llm`: Retry and model failover policy used by the executor
        //! # Execution
        //!
        ...
        //! ```
        //!
        //! Retry and model failover are supplied by the `llm` crate; callers
        //! interact with the session-turn executor.
        //!
