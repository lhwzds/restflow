...
impl AgentOperationAssessor for WarningAssessor {
    ...
    async fn assess_task_create(
        &self,
        _request: ::types::store::TaskCreateRequest,
    ) -> crate::Result<OperationAssessment> {
        unreachable!("unused in this test")
    }
    ...
    async fn assess_task_update(
        &self,
        _request: ::types::store::TaskUpdateRequest,
    ) -> crate::Result<OperationAssessment> {
        unreachable!("unused in this test")
    }
    ...
    async fn assess_task_delete(
        &self,
        _request: ::types::store::TaskDeleteRequest,
    ) -> crate::Result<OperationAssessment> {
        unreachable!("unused in this test")
    }
    ...
    async fn assess_task_control(
        &self,
        _request: ::types::store::TaskControlRequest,
    ) -> crate::Result<OperationAssessment> {
        unreachable!("unused in this test")
    }
