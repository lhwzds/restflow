...
//!
//! ```rust
//! use runtime::models::security::{SecurityPolicy, CommandPattern, SecurityAction};
//!
...
impl From<&types::security::ToolAction> for ToolAction {
    fn from(action: &types::security::ToolAction) -> Self {
        Self {
