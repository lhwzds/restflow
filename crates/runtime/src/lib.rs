...
pub const SKILLS_DIR_ENV: &str = "RESTFLOW_SKILLS_DIR";
...
pub fn default_skills_dir() -> Result<PathBuf> {
    ...
    Ok(PathBuf::from(home).join(".restflow").join("skills"))
}
