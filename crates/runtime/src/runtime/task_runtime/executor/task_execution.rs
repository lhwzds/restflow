...
impl AgentRuntimeExecutor {
    ...
    async fn execute_agent_with_client(
        ...
        agent_id: Option<&str>,
        initial_state: Option<ai::AgentState>,
        telemetry_context: ai::telemetry::TelemetryContext,
...
impl AgentExecutor for AgentRuntimeExecutor {
    ...
    /// 6. Executes the agent via ai::AgentExecutor
...
mod tests {
    ...
    fn task_telemetry_context_uses_runner_supplied_run_id() {
        ...
        let task = storage
            ...
            .expect("task");
        let stale_trace = ai::telemetry::RestflowTrace::new(
            "run-stale",
