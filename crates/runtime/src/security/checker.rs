...
use types::security::{SecurityDecision, SecurityGate};
...
impl SecurityChecker {
    ...
    pub async fn check_tool_action(
        &self,
        action: &types::security::ToolAction,
        agent_id: Option<&str>,
        task_id: Option<&str>,
