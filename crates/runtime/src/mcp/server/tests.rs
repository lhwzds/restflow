...
impl McpBackend for MockBackend {
    ...
    async fn delete_task(
        &self,
        request: ::types::store::TaskDeleteRequest,
    ) -> Result<::types::TaskCommandOutcome<::types::DeleteWithIdResponse>, String> {
        Ok(::types::TaskCommandOutcome::Executed {
    ...
    let create = server
        .handle_manage_tasks(ManageTasksParams {
            ...
            schedule: Some(serde_json::json!(
                ::types::request::TaskSchedule::Interval {
                    interval_ms: 60_000,
                    start_at: None,
                }
            )),
