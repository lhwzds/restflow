    ...
    async fn execute(&self, input: Value) -> Result<ToolOutput> {
        ...
        match action {
            ...
            ProcessAction::Log {
                ...
                let log = self.manager.log(&session_id, offset, limit)?;
