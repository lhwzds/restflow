...
pub const ALL_PROVIDER_META: &[ProviderMeta] = &[
    ...
    ProviderMeta {
        ...
        runtime_provider: LlmProvider::Anthropic,
        api_key_env: None,
        default_model_id: "claude-code-opus",
    ...
    ProviderMeta {
        ...
        default_model_id: "groq-llama4-maverick",
    ...
    ProviderMeta {
        ...
        default_model_id: "zai-coding-plan-glm-5",
    ...
    ProviderMeta {
        ...
        default_model_id: "minimax-coding-plan-m2-5",
